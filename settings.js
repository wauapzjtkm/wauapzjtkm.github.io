...
const collectionInfo = {
    name: "MEMELAND",
    title: "MEMELAND MINT", // Title prefix (ex "Buy your {name}") - You can use {name} to insert the collection name
    socialMedia: {
...
const mintInfo = {
    price: 0.015,         // Price per NFT.
    totalSupply: 220,   // Total supply of NFTs.
